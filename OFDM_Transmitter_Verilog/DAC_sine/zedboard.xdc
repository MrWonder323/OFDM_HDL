...
# JA Pmod - Bank 13 
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y11  [get_ports {count_o[0]}];  # "JA1"
set_property PACKAGE_PIN AA8  [get_ports {count_o[1]}];  # "JA10"
set_property PACKAGE_PIN AA11 [get_ports {count_o[2]}];  # "JA2"
set_property PACKAGE_PIN Y10  [get_ports {count_o[3]}];  # "JA3"
set_property PACKAGE_PIN AA9  [get_ports {count_o[4]}];  # "JA4"
set_property PACKAGE_PIN AB11 [get_ports {count_o[5]}];  # "JA7"
set_property PACKAGE_PIN AB10 [get_ports {count_o[6]}];  # "JA8"
set_property PACKAGE_PIN AB9  [get_ports {count_o[7]}];  # "JA9"


# ----------------------------------------------------------------------------
# JB Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN W12 [get_ports {phase[0]}];  # "JB1"
set_property PACKAGE_PIN W11 [get_ports {phase[1]}];  # "JB2"
set_property PACKAGE_PIN V10 [get_ports {phase[2]}];  # "JB3"
set_property PACKAGE_PIN W8 [get_ports {phase[3]}];  # "JB4"
set_property PACKAGE_PIN V12 [get_ports {phase[4]}];  # "JB7"
set_property PACKAGE_PIN W10 [get_ports {phase[5]}];  # "JB8"
set_property PACKAGE_PIN V9 [get_ports {phase[6]}];  # "JB9"
set_property PACKAGE_PIN V8 [get_ports {phase[7]}];  # "JB10"
