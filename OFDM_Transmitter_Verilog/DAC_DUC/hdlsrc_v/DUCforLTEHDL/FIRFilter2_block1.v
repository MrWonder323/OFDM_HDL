// -------------------------------------------------------------
// 
// File Name: hdlsrc_v\DUCforLTEHDL\FIRFilter2_block1.v
...
module FIRFilter2_block1
  ...
  Addressable_Delay_Line_block8 u_delayLine0 (.clk(clk),
                                              .reset(reset),
                                              .enb(enb),
  ...
  Addressable_Delay_Line_block8 u_delayLine1 (.clk(clk),
                                              .reset(reset),
                                              .enb(enb),
  ...
  Addressable_Delay_Line_block8 u_delayLine2 (.clk(clk),
                                              .reset(reset),
                                              .enb(enb),
  ...
  Addressable_Delay_Line_block8 u_delayLine3 (.clk(clk),
                                              .reset(reset),
                                              .enb(enb),
  ...
  FilterTapSystolic_block1 u_filterTap4 (.clk(clk),
                                         .enb(enb),
  ...
  FilterTapSystolic_block1 u_filterTap5 (.clk(clk),
                                         .enb(enb),
  ...
  FilterTapSystolic_block1 u_filterTap6 (.clk(clk),
                                         .enb(enb),
  ...
  FilterTapSystolic_block1 u_filterTap7 (.clk(clk),
                                         .enb(enb),
  ...
  FilterTapSystolic_block1 u_filterTap8 (.clk(clk),
                                         .enb(enb),
