// -------------------------------------------------------------
// 
// File Name: hdlsrc_v\DUCforLTEHDL\Halfband_Interpolator.v
...
module Halfband_Interpolator
  ...
  wire ValidPipeline1;
  reg signed [17:0] intdelay_reg_1 [0:2];  // sfix18 [3]
  wire signed [17:0] intdelay_reg_next_1 [0:2];  // sfix18_En14 [3]
  ...
  assign FIROutputCastDBP1 = intdelay_reg_1[2];
