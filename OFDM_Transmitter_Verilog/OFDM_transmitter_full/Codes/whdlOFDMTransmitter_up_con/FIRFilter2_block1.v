// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\whdlOFDMTransmitter_up_con\FIRFilter2_block1.v
...
module FIRFilter2_block1
  ...
  reg signed [15:0] delayLineDataIn6_1;  // sfix16_En13
  ...
  reg signed [15:0] delayLineDataIn7_1;  // sfix16_En13
  ...
  reg signed [15:0] delayLineDataIn8_1;  // sfix16_En13
  reg [3:0] wrAddr8;  // ufix4
  reg [3:0] rdAddrDelayLine8;  // ufix4
  wire signed [15:0] delayLineEnd8deadOut;  // sfix16_En13
  ...
  wire signed [32:0] sumOut_6;  // sfix33_En28
  wire signed [32:0] sumOut_7;  // sfix33_En28
  ...
  reg signed [15:0] delayLineDataIn6_3;  // sfix16_En13
  wire signed [15:0] delayLineEnd6_1;  // sfix16_En13
  wire signed [15:0] delayLineDataOut6_1;  // sfix16_En13
  reg signed [15:0] delayLineDataIn7_3;  // sfix16_En13
  wire signed [15:0] delayLineEnd7_1;  // sfix16_En13
  wire signed [15:0] delayLineDataOut7_1;  // sfix16_En13
  reg signed [15:0] delayLineDataIn8_3;  // sfix16_En13
  wire signed [15:0] delayLineEnd8deadOut_1;  // sfix16_En13
  ...
  wire signed [32:0] sumOut_8;  // sfix33_En28
  ...
  wire signed [32:0] sumOut_4_1;  // sfix33_En28
  wire signed [32:0] sumOut_5_1;  // sfix33_En28
  wire signed [32:0] sumOut_6_1;  // sfix33_En28
  wire signed [32:0] sumOut_7_1;  // sfix33_En28
  ...
  Addressable_Delay_Line_block17 u_delayLine6 (.clk(clk),
                                               .reset(reset),
                                               .enb_1_32_0(enb_1_32_0),
                                               .dataIn(delayLineDataIn6_1),  // sfix16_En13
  ...
  Addressable_Delay_Line_block17 u_delayLine7 (.clk(clk),
                                               .reset(reset),
                                               .enb_1_32_0(enb_1_32_0),
                                               .dataIn(delayLineDataIn7_1),  // sfix16_En13
  ...
  Addressable_Delay_Line_block17 u_delayLine8 (.clk(clk),
                                               .reset(reset),
                                               .enb_1_32_0(enb_1_32_0),
                                               .dataIn(delayLineDataIn8_1),  // sfix16_En13
                                               .wrEn(delayLineShiftEn8_1),
                                               .wrAddr(wrAddr8),  // ufix4
                                               .rdAddr(rdAddrDelayLine8),  // ufix4
                                               .delayLineEnd(delayLineEnd8deadOut),  // sfix16_En13
  ...
  FilterTapSystolic_block3 u_filterTap5 (.clk(clk),
                                         .enb_1_32_0(enb_1_32_0),
                                         .din_re(delayLineDataOut5),  // sfix16_En13
  ...
  FilterTapSystolic_block3 u_filterTap6 (.clk(clk),
                                         .enb_1_32_0(enb_1_32_0),
                                         .din_re(delayLineDataOut6),  // sfix16_En13
  ...
  FilterTapSystolic_block3 u_filterTap7 (.clk(clk),
                                         .enb_1_32_0(enb_1_32_0),
                                         .din_re(delayLineDataOut7),  // sfix16_En13
                                         .coeff(coeffTableRegP7_1),  // sfix16_En15
                                         .sumIn(sumOut_5),  // sfix33_En28
                                         .sumOut(sumOut_6)  // sfix33_En28
                                         );

  FilterTapSystolic_block3 u_filterTap8 (.clk(clk),
                                         .enb_1_32_0(enb_1_32_0),
                                         .din_re(delayLineDataOut8),  // sfix16_En13
                                         .coeff(coeffTableRegP8_1),  // sfix16_En15
                                         .sumIn(sumOut_6),  // sfix33_En28
                                         .sumOut(sumOut_7)  // sfix33_En28
                                         );
  ...
  Addressable_Delay_Line_block18 u_delayLine6_1 (.clk(clk),
                                                 .reset(reset),
                                                 .enb_1_32_0(enb_1_32_0),
                                                 .dataIn(delayLineDataIn6_3),  // sfix16_En13
                                                 .wrEn(delayLineShiftEn6_1),
                                                 .wrAddr(wrAddr6),  // ufix4
                                                 .rdAddr(rdAddrDelayLine6),  // ufix4
  ...
  Addressable_Delay_Line_block18 u_delayLine7_1 (.clk(clk),
                                                 .reset(reset),
                                                 .enb_1_32_0(enb_1_32_0),
                                                 .dataIn(delayLineDataIn7_3),  // sfix16_En13
                                                 .wrEn(delayLineShiftEn7_1),
                                                 .wrAddr(wrAddr7),  // ufix4
                                                 .rdAddr(rdAddrDelayLine7),  // ufix4
  ...
  Addressable_Delay_Line_block18 u_delayLine8_1 (.clk(clk),
                                                 .reset(reset),
                                                 .enb_1_32_0(enb_1_32_0),
                                                 .dataIn(delayLineDataIn8_3),  // sfix16_En13
                                                 .wrEn(delayLineShiftEn8_1),
                                                 .wrAddr(wrAddr8),  // ufix4
                                                 .rdAddr(rdAddrDelayLine8),  // ufix4
                                                 .delayLineEnd(delayLineEnd8deadOut_1),  // sfix16_En13
  ...
  FilterTapSystolic_block4 u_filterTap5_1 (.clk(clk),
                                           .enb_1_32_0(enb_1_32_0),
                                           .din_im(delayLineDataOut5_1),  // sfix16_En13
                                           .coeff(coeffTableRegP5_3),  // sfix16_En15
                                           .sumIn(sumOut_3_1),  // sfix33_En28
                                           .sumOut(sumOut_4_1)  // sfix33_En28
                                           );

  FilterTapSystolic_block4 u_filterTap6_1 (.clk(clk),
                                           .enb_1_32_0(enb_1_32_0),
                                           .din_im(delayLineDataOut6_1),  // sfix16_En13
                                           .coeff(coeffTableRegP6_3),  // sfix16_En15
                                           .sumIn(sumOut_4_1),  // sfix33_En28
                                           .sumOut(sumOut_5_1)  // sfix33_En28
                                           );

  FilterTapSystolic_block4 u_filterTap7_1 (.clk(clk),
                                           .enb_1_32_0(enb_1_32_0),
                                           .din_im(delayLineDataOut7_1),  // sfix16_En13
                                           .coeff(coeffTableRegP7_3),  // sfix16_En15
                                           .sumIn(sumOut_5_1),  // sfix33_En28
                                           .sumOut(sumOut_6_1)  // sfix33_En28
                                           );

  FilterTapSystolic_block4 u_filterTap8_1 (.clk(clk),
                                           .enb_1_32_0(enb_1_32_0),
                                           .din_im(delayLineDataOut8_1),  // sfix16_En13
                                           .coeff(coeffTableRegP8_3),  // sfix16_En15
                                           .sumIn(sumOut_6_1),  // sfix33_En28
                                           .sumOut(sumOut_7_1)  // sfix33_En28
                                           );
