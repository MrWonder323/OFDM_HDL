// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\whdlOFDMTransmitter_up_con\FirRdyLogic_block3.v
...
module FirRdyLogic_block3
  ...
  input   validIn;
  output  signed [15:0] dinSM_re;  // sfix16_En13
  output  signed [15:0] dinSM_im;  // sfix16_En13
  output  dinVldSM;


  wire syncReset;
  reg signed [15:0] firRdy_xdin_re;  // sfix16_En13
  reg signed [15:0] firRdy_xdin_im;  // sfix16_En13
  reg  firRdy_xdinVld;
  reg [2:0] firRdy_state;  // ufix3
  reg  firRdy_readyReg;
  reg [3:0] firRdy_count;  // ufix4
  reg signed [15:0] firRdy_xdin_next_re;  // sfix16_En13
  reg signed [15:0] firRdy_xdin_next_im;  // sfix16_En13
  reg  firRdy_xdinVld_next;
  reg [2:0] firRdy_state_next;  // ufix3
  reg  firRdy_readyReg_next;
  reg [3:0] firRdy_count_next;  // ufix4
  reg  readySM;
  reg signed [15:0] dinSM_re_1;  // sfix16_En13
  reg signed [15:0] dinSM_im_1;  // sfix16_En13
  reg  dinVldSM_1;
  reg  firRdy_out2_0;
