// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\whdlOFDMTransmitter_up_con\whdlOFDMTx\whdlOFDMTx_Interleaver.v
...
// Source Path: whdlOFDMTx/Frame Generator/Data/Data Chain/Symbol Interleaver/Interleaver
// Hierarchy Level: 7
// 
// -------------------------------------------------------------
...
module whdlOFDMTx_Interleaver
  ...
  wire [9:0] Write_Logic_out1;  // ufix10
  wire Write_Logic_out2;
  wire [8:0] Write_Logic_out3;  // ufix9
  reg [8:0] Delay9_out1;  // ufix9
  wire [8:0] Store_Block_Lengths_out1;  // ufix9
  wire [9:0] Read_Logic_out1;  // ufix10
  ...
  reg [9:0] Delay16_reg [0:1];  // ufix10 [2]
  wire [9:0] Delay16_reg_next [0:1];  // ufix10 [2]
  wire [9:0] Delay16_out1;  // ufix10
  reg [9:0] Delay12_reg [0:6];  // ufix10 [7]
  wire [9:0] Delay12_reg_next [0:6];  // ufix10 [7]
  ...
  whdlOFDMTx_Generate_Ready u_Generate_Ready (.clk(clk),
                                              .reset(reset),
                                              .enb(enb),
  ...
  whdlOFDMTx_Write_Logic u_Write_Logic (.clk(clk),
                                        .reset(reset),
                                        .enb(enb),
                                        .start(startIn),
                                        .valid(Logical_Operator_out1),
                                        .end_rsvd(endIn),
                                        .wrAddr(Write_Logic_out1),  // ufix10
                                        .wrValid(Write_Logic_out2),
                                        .count(Write_Logic_out3),  // ufix9
  ...
  whdlOFDMTx_Store_Block_Lengths u_Store_Block_Lengths (.clk(clk),
                                                        .reset(reset),
                                                        .enb(enb),
                                                        .In(Delay9_out1),  // ufix9
                                                        .Push(Delay11_out1),
                                                        .Pop(Delay8_out1),
                                                        .Out(Store_Block_Lengths_out1),  // ufix9
                                                        .Num(Store_Block_Lengths_out2)  // ufix3
                                                        );

  whdlOFDMTx_Read_Logic u_Read_Logic (.clk(clk),
                                      .reset(reset),
                                      .enb(enb),
                                      .fifoData(Store_Block_Lengths_out1),  // ufix9
                                      .fifoCount(Store_Block_Lengths_out2),  // ufix3
                                      .rdAddr(Read_Logic_out1),  // ufix10
  ...
  always @(posedge clk or posedge reset)
    begin : Delay16_process
      if (reset == 1'b1) begin
        Delay16_reg[0] <= 10'b0000000000;
        Delay16_reg[1] <= 10'b0000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : Delay12_process
      if (reset == 1'b1) begin
        ...
        Delay12_reg[2] <= 10'b0000000000;
        Delay12_reg[3] <= 10'b0000000000;
        Delay12_reg[4] <= 10'b0000000000;
        Delay12_reg[5] <= 10'b0000000000;
        Delay12_reg[6] <= 10'b0000000000;
      end
      else begin
        if (enb) begin
  ...
  whdlOFDMTx_SimpleDualPortRAM_singlebit #(.AddrWidth(10),
                                           .DataWidth(1)
                                           )
...
endmodule  // whdlOFDMTx_Interleaver
