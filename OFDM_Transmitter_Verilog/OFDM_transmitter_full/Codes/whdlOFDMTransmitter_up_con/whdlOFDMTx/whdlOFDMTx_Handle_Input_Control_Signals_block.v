// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\whdlOFDMTransmitter_up_con\whdlOFDMTx\whdlOFDMTx_Handle_Input_Control_Signals_block.v
...
// Source Path: whdlOFDMTx/Frame Generator/Header/Interleaver/Write Logic/Handle Input Control Signals
// Hierarchy Level: 7
// 
// -------------------------------------------------------------
...
module whdlOFDMTx_Handle_Input_Control_Signals_block
  ...
  whdlOFDMTx_Generate_Forced_End_block u_Generate_Forced_End (.clk(clk),
                                                              .reset(reset),
                                                              .enb(enb),
  ...
  whdlOFDMTx_Generate_Current_Frame_Status_block u_Generate_Current_Frame_Status (.clk(clk),
                                                                                  .reset(reset),
                                                                                  .enb(enb),
...
endmodule  // whdlOFDMTx_Handle_Input_Control_Signals_block
