// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\whdlOFDMTransmitter_up_con\whdlOFDMTx\whdlOFDMTx_Frame_Controller_and_Input_Sampler.v
...
module whdlOFDMTx_Frame_Controller_and_Input_Sampler
  ...
  assign Transport_Block_Size_LUT_dout_low = Transport_Block_Size_LUT_1[({1'b0, Transport_Block_Size_LUT_k}) + Transport_Block_Size_LUT_add_cast_1];
  ...
  assign Transport_Block_Size_LUT_dout_right = Transport_Block_Size_LUT_1[({1'b0, Transport_Block_Size_LUT_k}) + Transport_Block_Size_LUT_add_cast_3];
  ...
  assign Transport_Block_Size_LUT_2 = {1'b0, Transport_Block_Size_LUT_1[({1'b0, Transport_Block_Size_LUT_k1inc}) + Transport_Block_Size_LUT_add_cast_6]};
  ...
  assign Transport_Block_Size_LUT_4 = {1'b0, Transport_Block_Size_LUT_1[({1'b0, Transport_Block_Size_LUT_k1inc}) + Transport_Block_Size_LUT_add_cast_12]};
