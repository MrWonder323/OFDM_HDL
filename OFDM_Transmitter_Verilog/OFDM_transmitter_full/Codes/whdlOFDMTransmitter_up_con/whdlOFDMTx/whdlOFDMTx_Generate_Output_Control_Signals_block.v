// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\whdlOFDMTransmitter_up_con\whdlOFDMTx\whdlOFDMTx_Generate_Output_Control_Signals_block.v
...
// Source Path: whdlOFDMTx/Frame Generator/Header/Interleaver/Read Logic/Generate Output Control Signals
// Hierarchy Level: 7
// 
// -------------------------------------------------------------
...
module whdlOFDMTx_Generate_Output_Control_Signals_block
  ...
  wire signed [7:0] Add_1;  // sfix8
  wire signed [7:0] Add_2;  // sfix8
  wire signed [7:0] Add_out1;  // int8
  wire signed [7:0] Relational_Operator1_1_1;  // sfix8
  ...
  wire signed [7:0] Add1_1;  // sfix8
  wire signed [7:0] Add1_2;  // sfix8
  wire signed [7:0] Add1_out1;  // int8
  wire signed [7:0] Relational_Operator3_1_1;  // sfix8
  ...
  assign Add_2 = {4'b0, Constant_out1};
  ...
  assign Compare_To_Constant_out1 = blockCount == 7'b0000000;
  ...
  assign Add1_2 = {4'b0, Constant2_out1};
...
endmodule  // whdlOFDMTx_Generate_Output_Control_Signals_block
