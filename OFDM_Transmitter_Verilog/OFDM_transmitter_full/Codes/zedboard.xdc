...
#set_property PACKAGE_PIN AB7 [get_ports {Out4_im_out[1]}];  # "JC1_P"
#set_property PACKAGE_PIN AA4 [get_ports {Out4_im_out[2]}];  # "JC2_N"
...
# JD Pmod - Bank 13
# ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN W7 [get_ports {Out4_im_out[8]}];  # "JD1_N"
#set_property PACKAGE_PIN V7 [get_ports {Out4_im_out[9]}];  # "JD1_P"
