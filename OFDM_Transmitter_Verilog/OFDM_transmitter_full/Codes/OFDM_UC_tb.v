...
module OFDM_UC_tb;
  ...
  reg  reset;
  wire clk_enable;
  wire [1:0] rawData_codeRateIndex;  // ufix2
  wire ready_done;  // ufix1
  wire ce_out_1;
  wire ready_done_enb;  // ufix1
  reg [18:0] ready_addr;  // ufix19
  ...
  reg [18:0] Data_Type_Conversion5_out1_addr;  // ufix19
  wire [18:0] Data_Type_Conversion1_out1_addr_delay_1;  // ufix19
  reg  tb_enb_delay;
  wire phase_2_valid;
  ...
  reg  valid_offset;
  wire valid;
  wire [18:0] Data_Type_Conversion3_out1_addr_delay_1;  // ufix19
  ...
  wire [14:0] txValid_addr_delay_1;  // ufix15
  ...
  wire [14:0] txData_re_addr_delay_1;  // ufix15
  ...
  wire [14:0] Out3_addr_delay_1;  // ufix15
  ...
  wire [14:0] Out4_re_addr_delay_1;  // ufix15
  ...
  assign rawData_codeRateIndex = 2'b00;
  ...
  assign ready_active = ready_addr != 19'b1110100111101110000;
  ...
  //  initial value   = 0
  //  step value      = 1
  //  count to value  = 479088
  always @(posedge clk or posedge reset)
    begin : c_process
      if (reset == 1'b1) begin
        ready_addr <= 19'b0000000000000000000;
      end
      else begin
        if (ready_enb) begin
          if (ready_addr >= 19'b1110100111101110000) begin
            ready_addr <= 19'b0000000000000000000;
          end
          else begin
            ready_addr <= ready_addr + 19'b0000000000000000001;
          end
        end
      end
    end
  ...
  assign ready_lastAddr = ready_addr >= 19'b1110100111101110000;
  ...
  assign Out4_re_lastAddr = txValid_addr >= 15'b111010011110111;
  ...
  assign Out3_lastAddr = txValid_addr >= 15'b111010011110111;
  ...
  assign txData_re_lastAddr = txValid_addr >= 15'b111010011110111;
  ...
  assign txValid_active = txValid_addr != 15'b111010011110111;
  ...
  assign #2 codeRateIndex_1 = codeRateIndex_offset;

  assign Data_Type_Conversion5_out1_active = Data_Type_Conversion5_out1_addr != 19'b1110100111101110000;
  ...
  always @(posedge clk or posedge reset)
    begin : DataTypeConversion5_process
      if (reset == 1'b1) begin
        Data_Type_Conversion5_out1_addr <= 19'b0000000000000000000;
      end
      else begin
        if (Data_Type_Conversion5_out1_enb) begin
          if (Data_Type_Conversion5_out1_addr >= 19'b1110100111101110000) begin
            Data_Type_Conversion5_out1_addr <= 19'b0000000000000000000;
          end
          else begin
            Data_Type_Conversion5_out1_addr <= Data_Type_Conversion5_out1_addr + 19'b0000000000000000001;
          end
        end
      end
    end
  ...
  OFDM_UC u_OFDM_UC (.clk(clk),
                     ...
                     .codeRateIndex(codeRateIndex_1),  // ufix2
                     .data(data),
                     .valid(valid),
                     .ce_out_0(ce_out_0),
                     .ce_out_1(ce_out_1),
  ...
  //  initial value   = 0
  //  step value      = 1
  //  count to value  = 29943
  always @(posedge clk or posedge reset)
    begin : c_4_process
      if (reset == 1'b1) begin
        txValid_addr <= 15'b000000000000000;
      end
      else begin
        if (txValid_enb) begin
          if (txValid_addr >= 15'b111010011110111) begin
            txValid_addr <= 15'b000000000000000;
          end
          else begin
            txValid_addr <= txValid_addr + 15'b000000000000001;
          end
        end
      end
    end
  ...
  assign txValid_lastAddr = txValid_addr >= 15'b111010011110111;
